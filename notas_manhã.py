...
if cnpj0 == ['']:
    print("WEB GLAMOUR")
    print(lista_nf_df0)
    lista_nf_df0.to_excel("NFe Web Glamour.xlsx")
if cnpj0 == ['']:
    print("ARMAZEM MAMOEIRO")
    print(lista_nf_df0)
    lista_nf_df0.to_excel("NFe Armazem Mamoeiro.xlsx")
if cnpj1 == ['']:
    print("WEB GLAMOUR")
    print(lista_nf_df1)
    lista_nf_df1.to_excel("NFe Web Glamour.xlsx")
if cnpj1 == ['']:
    print("ARMAZEM MAMOEIRO")
    print(lista_nf_df1)
    lista_nf_df1.to_excel("NFe Armazem Mamoeiro.xlsx")
